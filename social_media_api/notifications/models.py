...
class Notification(models.Model):
    recipient = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,related_name='nofications_for_actor') # the user who will receive the notification
    actor  = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='notifications_for_recipient') # the user who performed the action such as liking the post
    verb = models.CharField(max_length=150) # description of the action
