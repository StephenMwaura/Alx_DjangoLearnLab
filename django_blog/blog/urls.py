...
from .views import SignUpView , CommentListView, CommentCreateView, CommentDeleteView, CommentUpdateView , view_search , tag_view
...
urlpatterns = [
    ...
    path('tags/<slug:tag_name>/',tag_view, name='posts_tag'),
] 
