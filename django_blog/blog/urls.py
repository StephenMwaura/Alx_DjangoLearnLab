...
urlpatterns = [
    ...
    path('posts//comment/<int:pk>delete/',CommentDeleteView.as_view(), name='comment-_delete'),
    path('posts/comment/<int:pk>/update/',CommentUpdateView.as_view(), name = 'comment_update'),
